...
class WP_Zcraft_Nav_Walker extends Walker_Nav_Menu
{
    ...
    public function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0)
    {
        ...
        {
            $output .= $indent . '<li role="presentation"><hr />';
        }
        ...
        else
        {
            ...
            $element_type = empty($atts['href']) ? 'span' : 'a';

            $item_output  = $args->before . '<' . $element_type . $attributes .'>';
            $item_output .= $args->link_before . apply_filters('the_title', $item->title, $item->ID) . $args->link_after;
            $item_output .= '</' . $element_type . '>' . $args->after;
